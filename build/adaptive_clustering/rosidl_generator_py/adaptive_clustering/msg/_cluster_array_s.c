...
bool adaptive_clustering__msg__cluster_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("adaptive_clustering.msg._cluster_array.ClusterArray", full_classname_dest, 51) == 0);
  }
  adaptive_clustering__msg__ClusterArray * ros_message = _ros_message;
  {  // header
...
PyObject * adaptive_clustering__msg__cluster_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("adaptive_clustering.msg._cluster_array");
