...
static const _ClusterArray_type_support_symbol_names_t _ClusterArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, adaptive_clustering, msg, ClusterArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, adaptive_clustering, msg, ClusterArray)),
  }
};
...
{
  return &::adaptive_clustering::msg::rosidl_typesupport_cpp::ClusterArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, adaptive_clustering, msg, ClusterArray)() {
  return get_message_type_support_handle<adaptive_clustering::msg::ClusterArray>();
}
