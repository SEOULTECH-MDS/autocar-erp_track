...
#define NODE_MAIN_LOGGER_NAME "adaptive_clustering_ground_removed_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libadaptive_clustering_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<perception::AdaptiveClusteringGroundRemoved>";
