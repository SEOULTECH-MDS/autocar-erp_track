...
#define NODE_MAIN_LOGGER_NAME "patchworkpp_comp_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpatchworkpp.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<patchworkpp::PatchworkppPointXYZI>";
