...
class SensorFusion(Node):
    def __init__(self):
        ...
        self.intrinsic_left = np.array([[620.764857480596,   0., 317.848118604627, 0.],
                                         [0., 618.852621231630, 228.868765431637, 0.],
                                         [0., 0., 1., 0.]])
        self.extrinsic_left = np.array([[0.580948611410505, -0.810685399413119, 0.0727179075510119, 0.575163273740086],
                                        [-0.420619208528097, -0.375502497523272, -0.825879746555745, 0.460923010414268],
                                        [0.696834408103821, 0.449207143233694, -0.559137505583752, 0.715386898145549],
                                        [0., 0., 0., 1.]])

        self.intrinsic_right = np.array([[631.121481561481,   0., 316.265663416102, 0.],
                                          [0., 630.260339746933, 206.412468016589, 0.],
                                          [0., 0., 1., 0.]])
        self.extrinsic_right = np.array([[-0.523856575993279, -0.850722670753427, -0.0429560851888856, -0.581269240410840],
                                         [-0.447077204838429, 0.317525321599673, -0.836241378464903, 0.478317881921842],
                                         [0.725049143646454, -0.418865858729475, -0.546676441497495, 0.781155585152400],
                                         [0., 0., 0., 1.]])
