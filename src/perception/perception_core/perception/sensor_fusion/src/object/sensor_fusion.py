...
class SensorFusion(Node):
    def __init__(self):
        ...
        self.intrinsic_right = np.array([[607.937482922945,   0., 307.424134965486, 0.],
                                          ...
                                          [0., 0., 1., 0.]])
        self.extrinsic_right = np.array([[-0.546900071590167, -0.836960275916855, -0.0199451305298424, -0.485463496687171],
                                         [-0.431810307056041, 0.302410542493787, -0.849757449222295, 0.529450713738888],
                                         [0.717244846907133, -0.456119896875587, -0.526796421076840, 0.756024922139314],
                                         [0., 0., 0., 1.]])
