...
from perception.yolov11.models.common import Conv, DWConv
from perception.yolov11.utils.google_utils import attempt_download
...
def attempt_load(weights, map_location=None):
    ...
    for w in weights if isinstance(weights, list) else [weights]:
        ...
        # [✓] Modified: weights_only 인자를 False로 지정하여 전체 checkpoint를 로드하도록 변경
